$(function(){
    ...
    $('#balance').click(function(){
        ...
        $('#bid_amount').val(balance);
        $('#bid_cost').val(num_fix(balance*bid_price,2));
    });
    ...
    $('#bid_btn').click(function(){
        ...
        $('#confirm_text').html('价格：￥'+bid_price +'数量：'+bid_amount+'<br>收入：￥'+bid_cost);
        $('#confirm_modal').modal();
