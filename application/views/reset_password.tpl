                  ...
                  <div class='span4 offset4'>
                        <div class="account-form thumbnail">
                              ...
                              <form accept-charset="UTF-8" action="" class="form-vertical" method="post">
                                  <input  id="password_token" name="password_token"  value="<?php echo $token; ?>" type="hidden" />
                                <div class="control-group">
                                    <label class="control-label" for="new_password">新密码</label>
                                    <div class="controls">
                                      <input class="focus" id="new_password" name="new_password" placeholder="新密码" tabindex="1" type="password"  />
                                    </div>
                                </div>

                                <div class="control-group">
                                  <label class="control-label" for="confirm_new_password">再次输入密码</label>
                                  <div class="controls">
                                      <input class="focus" id="confirm_new_password" name="confirm_new_password" placeholder="再次输入密码" tabindex="2" type="password" />
                                  </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                      <input class="btn btn-primary pull-right" id="reset_password_button" name="commit" tabindex="3" type="submit" value="提交密码" />
                                    </div>
                                </div>
                              </form>
                        </div>
