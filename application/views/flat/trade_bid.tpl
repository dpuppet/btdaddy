...
<?php include('menu.tpl');?>
			...
			<div class="row-fluid">
				<div class="box span5">
					<div class="box-header">
						<h2><i class="icon-shopping-cart"></i>买入委托</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" />
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="col-sm-5 control-label" >最佳买价</label>
								<div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append">
                                            ...
                                            <a href="/recharge/cny_method"><label class="btn">充值</label></a>
                                        </div>
                                    </div>
                                </div>
							  <div class="control-group">
								<label class="control-label" for="appendedInput">购买价格</label>
								<div class="controls">
								  <div class="input-append">
                              ...
                              <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="appendedInput">购买金额</label>
                                    <div class="controls">
                                        <div class="input-append">
                                            <span class="add-on">￥</span>
                        ...
                        <div class="form-actions">
                            <button type="submit" id="bid_btn" class="btn btn-primary btn-block btn-large">买入(CNY->BTC)</button>
                        </div>
					</div>
				</div><!--/span-->
            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-header">
                        <h2><i class="icon-align-justify"></i><span class="break"></span>买入委托记录[最近10条]</h2>
                        <div class="box-icon">
...
<?php include('footer.tpl')?>
    <script src="/static/js/trade_bid.js"></script>
